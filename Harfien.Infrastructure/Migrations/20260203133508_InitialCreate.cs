        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CraftsmanId1 = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_CraftsmanId",
                        column: x => x.CraftsmanId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Craftsmen_CraftsmanId1",
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "AreaId", "ConcurrencyStamp", "CreatedAt", "DateOfBirth", "Email", "EmailConfirmed", "Fullname", "Gender", "IsActive", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "ProfileImage", "SecurityStamp", "TwoFactorEnabled", "UserName", "Zone" },
                values: new object[] { "ADMIN_ID", 0, "Cairo", null, "c06c7e77-11d7-4c81-bf31-cffe21639031", new DateTime(2026, 2, 3, 13, 35, 4, 896, DateTimeKind.Utc).AddTicks(8054), null, "Admin@gmail.com", true, "Nourhan Shaban", null, true, false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAEO4thzCYn3NMM3A/VD+yNDZ9E0cIDuhvYUlTv9OPTXSjTSNWR8/loBspc+F327b5QA==", "1234567890", true, null, "0a838cd3-f1a6-450d-b644-d872efec6513", false, "Admin@gamil.com", null });
